...
def _opencode_headers(session_id=None, cwd=None):
    ...
    return {
        ...
        "x-opencode-project": project_root,
        "x-opencode-directory": cwd,
        "x-opencode-workspace": project_root,  # Same as project for now
    }
